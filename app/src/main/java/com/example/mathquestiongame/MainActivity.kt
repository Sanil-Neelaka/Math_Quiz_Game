...
class MainActivity : AppCompatActivity() {
    ...
    private var allquestions:Int=40
    ...
    private fun showNextQuestion() {
        ...
        updateQuestionUI()
        startTimer()
        questionNumberTextView.text = "Question $currentQuestionNumber/$allquestions"
        if(allquestions+1!=currentQuestionNumber){
    ...
    private fun gamewon() {
        Toast.makeText(this, "Congratulations..! You Won \nYour score: $score", Toast.LENGTH_SHORT).show()
        ...
        timer?.cancel()
        currentQuestionNumber = 1
        title.setText("  Congradulations...! You won  \n\n Score: $score ")
        startButton.setText("    Play Again     ")
